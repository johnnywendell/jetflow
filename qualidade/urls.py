...
urlpatterns =[
    ...
    path('photo/create/<int:pk>/', v.photo_create, name='photo_create'),
    path('pdf/<int:pk>/', v.render_pdf_view, name='render_pdf_view'),
    path('pdfsimple/<int:pk>/', v.render_pdf_view_simple, name='render_pdf_view_simple'),
    ...
    path('photocheck/create/<int:pk>/', v.photo_create_check, name='photo_create_check'),
